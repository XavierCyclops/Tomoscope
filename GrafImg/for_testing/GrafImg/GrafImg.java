...
public class GrafImg extends MWComponentInstance<GrafImg>
{
    ...
    {
        this(GrafImgMCRFactory.newInstance());
    }
    ...
    {
        this(GrafImgMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(GrafImgMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = GrafImgMCRFactory.newInstance();
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] graficar(int nargout, Object... rhs) throws MWException
    {
