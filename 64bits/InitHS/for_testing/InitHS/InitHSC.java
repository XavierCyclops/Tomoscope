 ...
 * <pre>
 *  C:\\Users\\Acustic\\Documents\\NetBeansProjects\\Tomoscope\\64bits\\InitHS.m
 * </pre>
 ...
 * @version 0.0
 */
public class InitHSC extends MWComponentInstance<InitHSC>
{
    /**
    ...
    {
        this(InitHSMCRFactory.newInstance());
    }
    ...
    {
        this(InitHSMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>InitHSC</code> class. Use this constructor 
    ...
    {
        this(InitHSMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = InitHSMCRFactory.newInstance();
            mcr.runMain( sInitHSSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void InitHS(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sInitHSSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void InitHS(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sInitHSSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] InitHS(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sInitHSSignature), 
                    sInitHSSignature);
        return lhs;
    }
}
