SensitivityMatrix MATLAB Java Package
...
- SensitivityMatrix.jar must be included in your CLASSPATH.
...
-MCRInstaller.exe 
    ...
    Deployment Tool.
-Javadoc   
   - javadoc for SensitivityMatrix is in the doc directory. When  
