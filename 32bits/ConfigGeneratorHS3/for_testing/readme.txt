ConfigGeneratorHS3 MATLAB Java Package
...
- ConfigGeneratorHS3.jar must be included in your CLASSPATH.
...
-MCRInstaller.exe 
    ...
    Deployment Tool.
-Javadoc   
   - javadoc for ConfigGeneratorHS3 is in the doc directory. When  
